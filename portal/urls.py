...
from portal.views.teacher.teach import teacher_lesson_plans, teacher_lesson_plans_python, teacher_classes, teacher_class, \
    ...
    teacher_class_password_reset, teaching_pack_browser
...
urlpatterns = patterns(
    ...
    url(r'^teach/home/teaching_pack_browser/$', teaching_pack_browser, name='teaching_pack_browser'), #Trial URL for pdf browser
    url(r'^descriptions.html$', TemplateView.as_view(template_name="pdf_descrptions.html", content_type="html"), name="pdf_descriptions"), 
